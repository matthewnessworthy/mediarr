...
>
	...
	>
		...
		<div class="flex items-center gap-2 shrink-0 max-w-[50%]">
			<span class="truncate font-mono text-[11px] text-muted-foreground/60" title={result.source_path}>
				{basename(result.source_path)}
			</span>
			<span class="text-muted-foreground/30 shrink-0">&rarr;</span>
			<span class="truncate font-mono text-[11px] text-foreground/60" title={result.proposed_path}>
				{basename(result.proposed_path)}
			</span>
		</div>
